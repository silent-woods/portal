...
namespace Satyanam.Plugin.Misc.LeadAPI.ViewEngine;

public  class LeadAPIViewEngine : IViewLocationExpander
{
    #region Methods
    ...
    public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
    {
        ...
        if (context.AreaName == "Admin")
        {
            viewLocations = new[]
            {
                $"~/Plugins/Misc.LeadAPI/Areas/Admin/Views/{{1}}/{{0}}.cshtml",
                $"~/Plugins/Misc.LeadAPI/Areas/Admin/Views/Shared/{{0}}.cshtml"

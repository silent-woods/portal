...
namespace Satyanam.Nop.Plugin.SatyanamCRM.Models.Company
{
    public record CompanyModel : BaseNopEntityModel
    {
        public CompanyModel()
        {
            ...
            companyDealsModels = new List<CompanyDealsModel>();
            companyDealsSearchModel = new CompanyDealsSearchModel();
            companyContactSearchModel = new CompanyContactSearchModel();
            companyContactModels = new List<CompanyContactModel>();
        }
        ...
        public List<CompanyDealsModel> companyDealsModels { get; set; }
        public CompanyContactSearchModel companyContactSearchModel { get; set; }
        public List<CompanyContactModel> companyContactModels { get; set; }

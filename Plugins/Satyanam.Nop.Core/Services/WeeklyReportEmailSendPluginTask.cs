...
namespace Satyanam.Nop.Core.Services
{
    ...
    /// </summary>
    public partial class WeeklyReportEmailSendPluginTask : IScheduleTask
    {
        #region Fields
        ...
        public WeeklyReportEmailSendPluginTask(IEmailAccountService emailAccountService,
        ...
        public virtual async System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            if ((int)time.DayOfWeek == _monthlyReportSetting.WeekDay)
            {
                ...
                if (_monthlyReportSetting.DayTime_From.HasValue && _monthlyReportSetting.DayTime_To.HasValue)
                {
                    ...
                    {
                        await _workflowMessagePluginService.SendWeeklyReportMessageAsync((await _workContext.GetWorkingLanguageAsync()).Id);
                    }
                }
            }

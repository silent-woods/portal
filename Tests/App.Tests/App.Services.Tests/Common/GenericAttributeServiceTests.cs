...
namespace App.Tests.App.Services.Tests.Common
{
    [TestFixture]
    public class GenericAttributeServiceTests : ServiceTest
    {
        ...
        {
            var attribute = new global::App.Core.Domain.Common.GenericAttribute
            {
        ...
        {
            var attribute = new global::App.Core.Domain.Common.GenericAttribute { Key = "test", KeyGroup = "test", Value = "test" };

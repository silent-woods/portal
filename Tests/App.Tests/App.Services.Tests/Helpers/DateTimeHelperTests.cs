...
namespace App.Tests.App.Services.Tests.Helpers
{
    [TestFixture]
    public class DateTimeHelperTests : ServiceTest
    {
        ...
        public async Task SetUp()
        {
            ...
            _gmtPlus2MinskTimeZoneId = "E. Europe Standard SpentHours";  //(GMT+02:00) Minsk
            _gmtPlus3MoscowTimeZoneId = "Russian Standard SpentHours"; //(GMT+03:00) Moscow, St. Petersburg, Volgograd
            _gmtPlus7KrasnoyarskTimeZoneId = "North Asia Standard SpentHours"; //(GMT+07:00) Krasnoyarsk;

...
namespace App.Data.Migrations.UpgradeTo460
{
    ...
    public class DataMigration : Migration 
    {
        ...
        public override void Up()
        {
            ...
            //#5809
            if (!_dataProvider.GetTable<ScheduleTask>().Any(st => string.Compare(st.Type, "App.Services.Gdpr.DeleteInactiveCustomersTask, App.Services", StringComparison.InvariantCultureIgnoreCase) == 0))
            {
            ...
            if (!_dataProvider.GetTable<ScheduleTask>().Any(st => string.Compare(st.Type, "App.Services.Common.ResetLicenseCheckTask, App.Services", StringComparison.InvariantCultureIgnoreCase) == 0))
            {

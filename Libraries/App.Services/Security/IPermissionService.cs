...
namespace App.Services.Security
{
    ...
    public partial interface IPermissionService
    {
        ...
        Task<bool> AuthorizeAsync(PermissionRecord permission, PermissionAction permissionAction = PermissionAction.View);
        ...
        /// The task result contains the rue - authorized; otherwise, false
        /// </returns>
        Task<bool> AuthorizeAsync(string permissionRecordSystemName, Customer customer, PermissionAction permissionAction = PermissionAction.View);
        ...
        Task UpdatePermissionRecordCustomerRoleMappingAsync(PermissionRecordCustomerRoleMapping permissionRecordCustomerRoleMapping);

        Task<PermissionRecordCustomerRoleMapping> GetExistingActionsByPermissionAndRoleAsync(int permissionId = 0, int roleId = 0);

        #region Permission Record User Mapping Methods

        Task InsertPermissionRecordUserMappingAsync(PermissionRecordUserMapping permissionRecordUserMapping);

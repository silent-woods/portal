...
namespace App.Web.Areas.Admin.Models.Stores
{
    ...
    public partial record StoreModel : BaseNopEntityModel, ILocalizedModel<StoreLocalizedModel>
    {
        ...
        [UIHint("Picture")]
        [NopResourceDisplayName("Admin.Configuration.Stores.Fields.LogoPictureId")]
        public int LogoPictureId { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Stores.Fields.Email")]
        [Required(ErrorMessage = "Please enter a email.")]
        public string Email { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Stores.Fields.Website")]

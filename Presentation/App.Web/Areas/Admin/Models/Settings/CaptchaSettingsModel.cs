...
namespace App.Web.Areas.Admin.Models.Settings
{
    ...
    public partial record CaptchaSettingsModel : BaseNopModel, ISettingsModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.GeneralCommon.CaptchaShowOnCareerPage")]
        public bool ShowOnCareerPage { get; set; }
        public bool ShowOnCareerPage_OverrideForStore { get; set; }

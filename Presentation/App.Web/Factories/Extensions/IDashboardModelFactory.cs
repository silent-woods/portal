...
namespace App.Web.Factories.Extensions
{
    public partial interface IDashboardModelFactory
    {
        ...
        Task<PendingDashboardModel> PrepareOverdueDashboardModelAsync(int currEmployeeId = 0, int projectId = 0, int employeeId = 0, string taskName = null, int statusId = 0, bool holdOnly = false);
    }
}
